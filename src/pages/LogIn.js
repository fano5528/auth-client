    ...
    return (
        <div>
            ...
            <form onSubmit={(e)=> trySubmit(e)} className="mt-12 flex w-[50vw] mx-auto border-black shadow-[0_0_15px_5px_rgba(0,0,0,0.05)] p-12 rounded-lg flex-col">
                <input className="rounded-md" type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
                <input className="mt-6 rounded-md" type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
